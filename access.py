...
SECRET_FILE = "youtube_proc/secret.json"
...
APP_TOKEN_FILE = "youtube_proc/client_secret.json"
USER_TOKEN_FILE = "youtube_proc/user_token.json"
...
Get User Info 
'''
def get_user_info(channel_id = 'UCX7TLVDiNS4wEXUE2rozZqA'):
